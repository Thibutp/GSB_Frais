...
<div class="row">
    ...
    <div class="col-md-4">
        <form action="<?= HOST; ?>suivreFrais/action/selectionnerMois"
    ...
    <div class="col-md-4">
        <form action="<?= HOST; ?>suivreFrais/action/voirFiche"
              method="post" role="form">
            <div class="form-group">
            ...
            <input type="hidden" id="leVisiteur" name="leVisiteur" value="<?php echo $visiteurSelectionne ?>" />
            <input id="ok" type="submit" value="Valider" class="btn btn-success"
                   role="button">
            <input id="annuler" type="reset" value="Effacer" class="btn btn-danger"
                   role="button">
